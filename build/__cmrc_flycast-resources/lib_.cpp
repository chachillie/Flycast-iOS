...
// Pointers to fonts/Roboto-Medium.ttf.zip
extern const char* const f_806d_fonts_Roboto_Medium_ttf_zip_begin;
extern const char* const f_806d_fonts_Roboto_Medium_ttf_zip_end;
// Pointers to fonts/Roboto-Regular.ttf.zip
extern const char* const f_7f89_fonts_Roboto_Regular_ttf_zip_begin;
extern const char* const f_7f89_fonts_Roboto_Regular_ttf_zip_end;
// Pointers to fonts/fa-solid-900.ttf.zip
extern const char* const f_53d3_fonts_fa_solid_900_ttf_zip_begin;
extern const char* const f_53d3_fonts_fa_solid_900_ttf_zip_end;
// Pointers to resources/picture/buttons.png
extern const char* const f_1884_picture_buttons_png_begin;
extern const char* const f_1884_picture_buttons_png_end;
// Pointers to resources/picture/buttons-arcade.png
extern const char* const f_80cb_picture_buttons_arcade_png_begin;
extern const char* const f_80cb_picture_buttons_arcade_png_end;
...
get_root_index() {
    ...
    root_index.emplace(
        ...
        f_980d_fonts_dir.directory.add_file(
            "Roboto-Medium.ttf.zip",
            res_chars::f_806d_fonts_Roboto_Medium_ttf_zip_begin,
            res_chars::f_806d_fonts_Roboto_Medium_ttf_zip_end
        )
    );
    root_index.emplace(
        "fonts/Roboto-Regular.ttf.zip",
        f_980d_fonts_dir.directory.add_file(
            "Roboto-Regular.ttf.zip",
            res_chars::f_7f89_fonts_Roboto_Regular_ttf_zip_begin,
            res_chars::f_7f89_fonts_Roboto_Regular_ttf_zip_end
        )
    );
    root_index.emplace(
        "fonts/fa-solid-900.ttf.zip",
        f_980d_fonts_dir.directory.add_file(
            "fa-solid-900.ttf.zip",
            res_chars::f_53d3_fonts_fa_solid_900_ttf_zip_begin,
            res_chars::f_53d3_fonts_fa_solid_900_ttf_zip_end
        )
    );
    root_index.emplace(
        "picture/buttons.png",
        f_5456_picture_dir.directory.add_file(
            "buttons.png",
            res_chars::f_1884_picture_buttons_png_begin,
            res_chars::f_1884_picture_buttons_png_end
        )
    );
    root_index.emplace(
        "picture/buttons-arcade.png",
        f_5456_picture_dir.directory.add_file(
            "buttons-arcade.png",
            res_chars::f_80cb_picture_buttons_arcade_png_begin,
            res_chars::f_80cb_picture_buttons_arcade_png_end
        )
    );
    root_index.emplace(
